  ...
  routes: [
    {
      ...
      children: [
        ...
        {path: '/Home', name: 'Home', component: Home,},
        {
          ...
          children: [
            {path: '/NewUser/Index', name: 'NewUserIndex', component: NewUserIndex},
            {path: '/NewUser/Resume', name: 'NewUserResume', component: NewUserResume},
            {path: '/NewUser/Student', name: 'NewUserStudent', component: NewUserStudent},
            {path: '/NewUser/Company', name: 'NewUserCompany', component: NewUserCompany},
            {path: '/NewUser/Club', name: 'NewUserClub', component: NewUserClub},
            {path: '/NewUser/BindPhone', name: 'NewUserBindPhone', component: NewUserBindPhone},
          ]
        },
      ]
    },
